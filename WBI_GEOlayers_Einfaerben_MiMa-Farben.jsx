/*
WBI GEOlayers Einfärber – MiMa-Farben
...
Gestaltungsfarben:
WBI 5 – Sehr hohe Gefahr: #a62121
WBI 4 – Hohe Gefahr:      #fd6165
WBI 3 – Mittlere Gefahr:  #fabb7a
WBI 2 – Geringe Gefahr:   #f8f287
WBI 1 – Sehr geringe Gefahr: #d0cbc2
*/
...
(function WBIColorizer(thisObj) {
    ...
    function buildUI(thisObj) {
        var panel = (thisObj instanceof Panel)
            ? thisObj
            : new Window("palette", "WBI GEOlayers Einfärber – MiMa-Farben", undefined, { resizeable: true });
        ...
        var palettePanel = panel.add("panel", undefined, "Farben · MiMa-Farben");
        ...
        var statusLabel = panel.add("statictext", undefined, "Bereit · MiMa-Farben.", { multiline: true });
