...
(function WBIColorizerAKT(thisObj) {
    "use strict";

    var PALETTE = [
        { level: 5, name: "Sehr hohe Gefahr", fullName: "WBI 5 - Sehr hohe Gefahr", hex: "#71207f", rgb: [113 / 255, 32 / 255, 127 / 255] },
        { level: 4, name: "Hohe Gefahr", fullName: "WBI 4 - Hohe Gefahr", hex: "#c61e1e", rgb: [198 / 255, 30 / 255, 30 / 255] },
        { level: 3, name: "Mittlere Gefahr", fullName: "WBI 3 - Mittlere Gefahr", hex: "#ff8b00", rgb: [255 / 255, 139 / 255, 0 / 255] },
        { level: 2, name: "Geringe Gefahr", fullName: "WBI 2 - Geringe Gefahr", hex: "#fec804", rgb: [254 / 255, 200 / 255, 4 / 255] },
        { level: 1, name: "Sehr geringe Gefahr", fullName: "WBI 1 - Sehr geringe Gefahr", hex: "#c1bdb2", rgb: [193 / 255, 189 / 255, 178 / 255] }
    ];
    ...
    var win = new Window("palette", "WBI Einfaerben - AKT");
